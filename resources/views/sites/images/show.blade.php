            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="card-header py-8 px-10 bg-grey-lighter flex items-center w-full ">
                    ...
                    <div class="back mr-8 hidden md:block">
                        <a href="{{ route('user-images.index', $site) }}" class="text-grey-darkest hover:text-blue no-underline">
                    ...
                    <div>
                        ...
                        <span class="block text-xl font-semibold text-blue-darker">{{ $image->alt ?? $image->url }}</span>
                        <a href="{{ $image->url }}" rel="noreferrer" class="block mt-1 opacity-75 text-blue-darker no-underline hover:underline hover:text-blue-dark">{{ $image->url }}</a>
                ...
                <div class="card-body p-10">
                    ...
                    @if ($image->found_on)
                        <span class="text-grey-dark">This Image was found on:</span> {{ $image->found_on->url }}
                    @endif
